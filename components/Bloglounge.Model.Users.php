<?php
	Class User {
		...
		function getMembers($keyword = '', $page = 0, $pageCount = 0) {		
			global $database, $db;
			...
			if($page > 0 && $pageCount > 0) {
				...
				$result = $db->queryAll('SELECT id, loginid, name, is_admin, is_accepted, created FROM '.$database['prefix'].'Users '.$sQuery.' ORDER BY created DESC');
			}
